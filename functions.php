...
*
* To override sandbox_setup() in a child theme,
* add your own sandbox_setup to your child theme's functions.php file.
*/
...
*/
function sandbox_scripts_method() {
...
add_action('wp_enqueue_scripts', 'sandbox_scripts_method');
